...
<div class="content">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title">Request New Order</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="<?= base_url('ngo/requestOrder');?>" enctype="multipart/form-data" method="post">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="restaurant_id">
                                <?php
                                    if(isset($rs_restaurants)){
                                        foreach($rs_restaurants as $rec_restaurant){
                                ?>
                                            <option value="<?=$rec_restaurant->id;?>"><?=$rec_restaurant->full_name;?></option>
                                <?php
                                        }
                                    }
                                ?>
                ...
                <div class="m-t-20 text-center">
                    <button class="btn btn-primary submit-btn">Create New Request Order</button>
                </div>
            </form>
        </div>
    </div>
