...
<div class="content">
    ...
    <form action="<?= base_url('rider/orderHistory');?>" method="post">
        <?php
            if(isset($current_order_id)){
        ?>
                <div class="row">
                    <div class="col-sm-12">
                        <a href="<?= base_url('rider/orderHistory');?>" style="color:red;">Clear Search</a>
                    </div>
                </div>
        <?php
            }
                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="<?= base_url('rider/historyView').'/'.$rec->id;?>"><i class="fa fa-pencil m-r-5"></i> View Order</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
