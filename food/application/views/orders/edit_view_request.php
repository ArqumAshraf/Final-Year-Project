...
<div class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="<?= base_url('restaurant/editRequestOrder');?>" enctype="multipart/form-data" method="post">
                        ...
                        <table class="table table-hover table-white">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control" value="<?=$rec_order->request_qty;?>" name="donate_qty[<?=$rec_order->order_detail_id;?>]" required>
                                    </td>
                                </tr>
                                <?php
                                        }
